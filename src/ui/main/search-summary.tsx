...
export default function SearchSummary(
    ...
    const totalPages =  Math.ceil( totalHits || 0  / ITEMS_PER_PAGE);
    const start = (ITEMS_PER_PAGE * (currentPage || 0-1)) + 1;
    const next = (totalPages - (currentPage || 0)) >= 1 ? ((start-1) + ITEMS_PER_PAGE) : (totalHits)
